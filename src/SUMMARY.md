...
- [Building Abstractions with Data](./02intro.md)
  ...
  - [Systems with Generic Operations](./02generic_operations.md)
- [Modularity, Objects and State](./03objects_state.md)
- [Metalinguistic Abstraction](./04metalinguistic.md)
- [Computing with Register Machines](./05register_machines.md)
