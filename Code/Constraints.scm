...
(define (make-connector)
  (let ((value false) (informant false) (contraints NULL))
    (define (set-my-value newval setter)
      (cond ((not (has-value?  me))
             (set! value newval)
             (set! informat setter)
             (for-each-except setter
                              informat-about-value
                              constraints))
            ((not (= value newval))
    ...
    (define (connect new-constraints)
      ...
      (if (has-value? me)
        (informat-about-value new-contraint))
      'done)
    (define (me request)
...
(define (connect connector new-constraints)
